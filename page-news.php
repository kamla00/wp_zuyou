...
.news-card__thumbnail { width: 100%; aspect-ratio: 16 / 9; overflow: hidden; background: #f5f5f5; }
...
.news-category { font-size: 1.1rem; padding: 2px 10px; border-radius: 4px; background: var(--mh--color--primary-50); color: var(--mh--color--primary-600); font-weight: 700; }
